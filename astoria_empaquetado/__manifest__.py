{
    ...
    'summary': 'Convierte producto a granel en presentaciones comerciales (Reempaque) usando movimientos estándar de inventario (sin Órdenes de Fabricación).',
    'description': """
        Módulo de Conversión y Empaque (Reempaque)
        ===========================================
        ...
        trazabilidad completa por lote. Se accede desde
